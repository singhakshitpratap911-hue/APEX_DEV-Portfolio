        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Akshit Pratap Singh</span>, a Computer Science & Engineering undergraduate specializing in Artificial Intelligence & Machine Learning, with hands-on exposure in cybersecurity, network traffic analysis, AI-powered threat detection, and software development. I build practical, documented solutions — from Wireshark packet analysis to hackathon prototypes.
            </motion.p>
