    ...
    <section className="relative w-full min-h-[100svh] overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black md:cursor-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-center md:justify-end">
        ...
        <video
          ...
          playsInline
          preload="auto"
          className="hero-video hero-video-landscape h-full w-full max-w-none object-cover object-center md:h-screen md:w-auto md:object-contain md:object-right md:scale-[0.98] lg:scale-100"
        >
        ...
        <video
          ...
          playsInline
          preload="auto"
          className="hero-video hero-video-portrait h-full w-full max-w-none object-cover object-center"
        >
        ...
        <div className="absolute bottom-5 right-4 sm:bottom-6 sm:right-6 lg:bottom-10 lg:right-12 pointer-events-none flex items-center justify-center z-10">
          <div className="relative flex items-center justify-center">
            ...
            >
              <img
                ...
                className="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 object-contain drop-shadow-[0_0_15px_rgba(212,175,55,0.25)]"
              />
            </motion.div>
          </div>
        </div>
      ...
      {/* ================= 4. CONTENT LAYER ================= */}
      <div className="relative z-10 flex flex-col justify-between min-h-[100svh] w-full px-4 sm:px-12 lg:px-16 pt-5 pb-6 sm:pt-6 sm:pb-8 pointer-events-none">
        ...
        {/* Main Hero Row */}
        <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between w-full pt-8 sm:pt-4 pb-2 my-auto">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-3.5 select-none">
              <h1
                className="text-[3.35rem] xs:text-6xl sm:text-7xl md:text-8xl lg:text-[7.2rem] xl:text-[7.8rem] tracking-tight uppercase leading-[0.83]"
            ...
            >
              ...
              <motion.a
                ...
                className="relative inline-flex items-center space-x-2 sm:space-x-3 px-4 sm:px-7 py-3.5 border border-[#8C6D4F] bg-[#120F0C]/80 hover:border-[#D4AF37] text-[#EAD8C7] hover:text-[#FFF5EB] text-[11px] font-medium tracking-[0.24em] uppercase transition-all duration-300 shadow-[0_0_25px_rgba(212,175,55,0.18)]"
              >
              ...
              <motion.a
                ...
                onMouseLeave={() => setIsHovered(false)}
                whileHover={{ scale: 1.02 }}
                className="relative inline-flex items-center space-x-2 px-4 sm:px-7 py-3.5 border border-[#8C6D4F]/40 hover:border-[#8C6D4F] text-[#BFA895] hover:text-[#EAD8C7] text-[11px] font-medium tracking-[0.24em] uppercase transition-all duration-300"
              >
