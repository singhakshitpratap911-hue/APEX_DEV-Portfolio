...
const bentoCategories = [
  {
    ...
    badge: 'CORE SKILLS',
    items: ['Python', 'C', 'C++', 'JavaScript', 'HTML', 'CSS', 'Shell Scripting'],
  ...
  },
  {
    ...
    badge: 'SECURITY',
    items: ['Wireshark', 'Nmap', 'Hping3', 'Hydra', 'Kali Linux', 'Packet Inspection'],
    description: 'Analyzing packet telemetry, inspecting network traffic, and studying threat patterns and authorized security testing techniques in controlled environments.',
  ...
  },
  {
    ...
    items: ['Machine Learning', 'Random Forest', 'Computer Vision', 'Pose Estimation', 'Generative AI', 'Prompt Engineering'],
  ...
  },
  {
    ...
    badge: 'EXECUTION',
    items: ['Git', 'GitHub', 'React', 'Vite', 'Tailwind CSS', 'MVVM', 'Clean Architecture', 'Rapid Prototyping'],
    description: 'Turning problem statements into working prototypes, modular architecture plans, and clear technical presentations under time constraints.',
