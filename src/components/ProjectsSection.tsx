...
const projects: Project[] = [
  {
    ...
    metrics: [
      ...
      { label: 'TEAM', value: 'AegisStrik' },
      { label: 'APPROACH', value: 'ML + Rule-Based' },
    ],
  },
  {
    number: '02',
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'FOCUS', value: 'Pose Guidance' },
    ],
  },
  {
    number: '04',
    ...
    metrics: [
      ...
      { label: 'THEME', value: 'Desert Environment' },
  ...
  },
  {
    ...
    description: 'An automated campus issue reporting concept developed during U-HACK 4.0, a time-constrained innovation hackathon. The work included rapid prototyping, collaborative solution development, system architecture, and technical pitch preparation.',
    githubUrl: 'https://github.com/singhakshitpratap911-hue',
    ...
    metrics: [
      ...
      { label: 'FOCUS', value: 'Campus Reporting' },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to unfold the project cards. Each build documents a practical solution across cybersecurity, AI/ML, and software engineering.
          </p>
        </motion.div>
